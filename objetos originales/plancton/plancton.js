...
class plancton extends THREE.Object3D {
  ...
  update() {
    ...
    /*if(this.brazo1HaciaDelante){
      this.brazo1.rotation.x += 0.05;  

      if(this.brazo1.rotation.x >= THREE.MathUtils.degToRad(40)){
        this.brazo1.rotation.x = THREE.MathUtils.degToRad(40);
        this.brazo1HaciaDelante = false;
      }
    }else{
      this.brazo1.rotation.x -= 0.05;
