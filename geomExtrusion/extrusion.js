...
class Extrusion extends THREE.Object3D {
  constructor() {
    ...
    var options1 = { depth: 4, steps: 100, bevelEnabled: false};    //Qué hacen los steps
    var geometry1 = new THREE.ExtrudeGeometry(shape, options1);

    var options2 = { depth: 8, steps: 2, curveSegments: 10, bevelSegments: 4, bevelSize: 1, bevelThickness: 4};
    ...
    var extrusion = new THREE.Mesh(geometry2, material);

    this.add(extrusion);

    extrusion.scale.set(0.1, 0.1, 0.1);
