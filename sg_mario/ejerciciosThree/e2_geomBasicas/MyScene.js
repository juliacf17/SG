...
class MyScene extends THREE.Scene {
  constructor (myCanvas) { 
    ...
    // Y unos ejes. El método   this.createAxis()   se encarga de crearlos y añadirlos a la escena.
    ...
    this.esfera = new Sphere(this.gui, "Controles de la Esfera");
    this.toro =  new Torus(this.gui, "Controles del Toro");
    this.cubo = new Box(this.gui, "Controles del Cubo");
    this.icosaedro = new Icosaedro(this.gui, "Controles del Icosaedro");
    this.cono = new Cone(this.gui, "Controles del Cono");
    this.cilindro = new Cylinder(this.gui, "Controles del Cilindro");

    this.cubo.position.set(0, 1, 0);
    this.add (this.cubo);

    this.esfera.position.set(-2, 0, 0);
    this.add(this.esfera); 

    this.toro.position.set(2, 0, 0); 
    this.add(this.toro); 

    this.icosaedro.position.set(0, 2, 0);
    this.add (this.icosaedro); 

    this.cono.position.set(-2, 2, 0); 
    this.add(this.cono);

    this.cilindro.position.set (2, 2, 0); 
