...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.boxModel = new Box(this.gui, "Controles de la Caja");
    this.add (this.boxModel);

    this.sphereModel = new Sphere(this.gui, "Controles de la Esfera");
    this.add (this.sphereModel);

    this.coneModel = new Cone(this.gui, "Controles del Cono");
    this.add (this.coneModel);

    this.icosahedronModel = new Icosahedron(this.gui, "Controles del Icosaedro");
    this.add (this.icosahedronModel);
  ...
  update () {
    ...
    this.boxModel.update();
    this.sphereModel.update();
    this.coneModel.update();
    this.icosahedronModel.update();
