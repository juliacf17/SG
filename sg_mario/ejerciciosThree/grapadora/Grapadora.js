...
class Grapadora extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    this.material = new THREE.MeshStandardMaterial({color: 'lightpink'});
  ...
  createBase(tama) {
    ...
    cajaBase.position.y = tama*0.04; // Una traslación 
  ...
  createMovil (tama) {
    ...
    movil.position.set(tama*0.45,tama*0.2,0); // Traslación respecto al sistema de referencia del nodo movil
