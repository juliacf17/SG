...
class MyScene extends THREE.Scene {
  ...
  constructor (myCanvas) { 
    ...
    this.cubo = new MyBox(this.gui, "Controles del Cubo");
    this.icosaedro = new MyIcosaedro (this.gui, "Controles del Icosaedro");
    this.cono = new MyCone (this.gui, "Controles del Cono");
    this.cilindro = new MyCylinder(this.gui, "Controles del Cilindro");

    this.add (this.cubo);

    this.esfera.position.set(-0.5, 0, 0);
    this.add(this.esfera); 

    this.toro.position.set(0.5, 0, 0); 
    this.add(this.toro); 

    this.icosaedro.position.set(0, 0.5, 0);
    this.add (this.icosaedro); 

    this.cono.position.set(-0.5, 0.5, 0); 
    this.add(this.cono);

    this.cilindro.position.set (0.5, 0.5, 0); 
